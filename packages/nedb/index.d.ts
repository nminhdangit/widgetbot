...
declare const Datastore: NedbPromises
export = Datastore
 ...
 * @class
 */
declare class NedbPromises extends EventEmitter {
  /**
  ...
  update<T>(query: any, updateQuery: any, options?: Nedb.UpdateOptions & { returnUpdatedDocs?: false }): Promise<number>

  update<T>(query: any, updateQuery: any, options?: Nedb.UpdateOptions & { returnUpdatedDocs: true; multi?: false }): Promise<T & Document>

  update<T>(query: any, updateQuery: any, options?: Nedb.UpdateOptions & { returnUpdatedDocs: true; multi: true }): Promise<(T & Document)[]>
   ...
   * https://github.com/louischatriot/nedb#creatingloading-a-database
   */
  create(options: Nedb.DatastoreOptions): NedbPromises
}
